...
/**
 * 拆借参数表
 * @TableName SECU_EXTEND_LENDING
 */
@TableName(value ="SECU_EXTEND_LENDING")
public class SecuExtendLending implements Serializable {
    /**
     * 证券代码
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        SecuExtendLending other = (SecuExtendLending) that;
